...
public class MNIST1_InternalData {
	...
	public MNIST1_InternalData(String path, String weights0file, String weights2file, String weights5file,
			String weights6file, String bias0file, String bias2file, String bias6file, String bias8file)
			throws NumberFormatException, IOException {

		File file = new File(path + "/" + weights0file);
		BufferedReader br = new BufferedReader(new FileReader(file));
		String st;
		Double[] Wvalues = new Double[72];
		int index = 0;
