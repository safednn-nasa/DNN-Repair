...
public class InternalData {
  ...
  public InternalData(String weights0file,String weights2file,String weights5file,String weights7file,String weights11file,String weights13file,String weights15file,String bias0file,String bias2file,String bias5file,String bias7file,String bias11file,String bias13file,String bias15file) throws NumberFormatException, IOException {
    ...
    biases11 = new Double[200];
    index = 0;
    for (int k = 0; k < 200; k++) {
      biases11[k] = Bvalues[index];
      index++;
    }
    weights11 = new Double[1024][200];
    index = 0;
    ...
    biases13 = new Double[200];
    index = 0;
    for (int k = 0; k < 200; k++) {
      biases13[k] = Bvalues[index];
      index++;
    }
    weights13 = new Double[200][200];
    index = 0;
    for (int I = 0; I < 200; I++)
      for (int J = 0; J < 200; J++)
          {
    ...
    biases15 = new Double[10];
    index = 0;
    for (int k = 0; k < 10; k++) {
      biases15[k] = Bvalues[index];
      index++;
    }
    weights15 = new Double[200][10];
    index = 0;
    for (int I = 0; I < 200; I++)
      for (int J = 0; J < 10; J++)
          {
            weights15[I][J] = Wvalues[index];
            index++;
          }
    br.close();
